...
\usepackage{amssymb}
% \usepackage[dvipdfmx]{animate} %アニメーションを作るのに必要
%\usepackage[dvipdfmx]{graphicx} %図を挿入するのに必要
% \mathbb{R}^{l} %表記例
% \usepackage{algorithm} %アルゴリズムを書くのに必要
% \usepackage{algorithmicx}
% \usepackage{algpseudocode}
\usepackage{animate} %アニメーションを作るのに必要

%%%% スライドの見た目 %%%%%
\usetheme{Madrid} %テーマ
\usefonttheme{professionalfonts} %フォント
