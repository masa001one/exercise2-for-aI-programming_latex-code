...
\begin{frame}{\insertsubsection}
	\begin{itemize}
		\item[$\ast$] 本スライドでは，ブラックボックス関数について説明する(前提知識の提供)
		\item[$\square$] 本スライドに，ブラックボックス関数の最適化の図を示す
...
\begin{frame}{\insertsubsection}
	\begin{itemize}
		...
		\begin{itemize}
			\item[$\circ$] 初めに前スライドで説明したブラックボックス関数の最適化を行うための手法として，ベイズ最適化があることを述べる
		\end{itemize}
...
\begin{frame}{\insertsubsection}
	\begin{itemize}
		\item[$\ast$] 本論文の貢献として，ベイズ最適化の一つの手法であるGP-UCBを提案したことを説明する
...
\begin{frame}{\insertsubsection}
	\begin{itemize}
		\item[$\ast$] 序論として，ガウス過程について説明する(前提知識の提供)
		\begin{itemize}
